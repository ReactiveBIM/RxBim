namespace RxBim.Nuke.Generators
{
    ...
    /// </summary>
    public static class ActionsSourceUtils
    {
        /// <summary>
...
{{
        ...
        private static SyntaxToken? GetActionNameToken(SyntaxNode attNode)
        {
        ...
        private static SyntaxToken GetNameWithVersionToken(SyntaxToken nameToken, string versionNumber)
        {
