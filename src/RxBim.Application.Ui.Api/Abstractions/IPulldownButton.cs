namespace RxBim.Application.Ui.Api.Abstractions
{
    ...
    /// PulldownButton
    /// </summary>
    public interface IPulldownButton : IButton
    {
        /// <summary>
        ...
        IPulldownButton Button(string name, string text, Type externalCommandType);
        ...
        /// <returns>Panel where button were created</returns>
        IPulldownButton Button(string name, string text, Type externalCommandType, Action<IButton> action);
    }
}