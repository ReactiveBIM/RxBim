...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        // private static readonly MetadataReference RxBimCommandReference = MetadataReference.CreateFromFile(typeof(RxBimCommand).Assembly.Location);
            ...
            Document[] documents)
        {
            ...
            foreach (var project in projects)
            {
                ...
                foreach (var diag in diags)
                {
                    ...
                    {
                        diagnostics
                            .AddRange(documents.Select(document => document.GetSyntaxTreeAsync().Result)
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            // .AddMetadataReference(projectId, RxBimCommandReference)
